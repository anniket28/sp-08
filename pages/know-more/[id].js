        ...
        <div className='my-10 shadow-md rounded-lg border-t-[1px] mx-5 md:mx-10'>
            ...
            <div className='lg:hidden'>
                ...
                <div className='mt-5 mb-3'>
                    <div className='shadow border-t-[1px] rounded-md w-5/6 mx-auto'>
                ...
                <div className='bg-teal-100 p-4'>
                    ...
                    <form className='mt-2'>
                        <div className='flex mx-auto mb-1'>
                            ...
                            <input type="number" name='contactNumber' className='rounded-md px-2 py-1 w-full text-sm' placeholder='Contact Number' />
                        </div>
                        <div className='text-center mt-3'>
                            <button className='bg-sky-500 px-2 py-1 text-white rounded-md text-sm' type='submit'>Submit</button>
                        </div>
                    </form>
                </div>
