    ...
    <div>
        ...
        <div className='px-0 flex flex-col items-center py-4 justify-between bg-slate-100 shadow-md md:px-10 lg:px-20 lg:flex-row lg:py-2'>
          ...
          <div className='flex flex-row md:flex-row lg:flex-row items-center space-x-2 contact-options'>
            <a href="tel:+91 8860217140" className='text-sm flex items-center bg-sky-500 px-2 py-2 rounded-md text-slate-100 hover:bg-green-500 lg:text-[16px]' style={{transition:'all 0.4s'}}><span className='text-xl'><IoCallSharp/></span><span className='ml-[1px]'>Call Us</span></a>
            <a onClick={sendMail} className='text-sm flex items-center bg-sky-500 px-2 py-2 rounded-md text-slate-100 hover:bg-green-500 cursor-pointer lg:text-[16px]'  style={{transition:'all 0.4s'}}><span className='text-xl'><MdEmail/></span><span className='ml-[1px]'>Email Us</span></a>
            <a onClick={openWhatsapp} className='text-sm flex items-center bg-sky-500 px-2 py-2 rounded-md text-slate-100 hover:bg-green-500 cursor-pointer lg:text-[16px]' style={{transition:'all 0.4s'}}><span className='text-xl'><RiWhatsappFill/></span><span className='ml-[1px]'>Connect on whatsapp</span></a>
          </div>
        </div>
        ...
        <nav>
          {/* For Small Devices */}
          <div className='bg-zinc-800 p-3 md:hidden lg:hidden'>
            {/*  */}
          ...
          {/* For Big Devices */}
          <div className='hidden md:flex md:flex-col md:py-3 lg:py-0 lg:flex lg:flex-row bg-zinc-800 justify-between items-center lg:px-28'>
            <ul className='flex space-x-7'>
              ...
              <Link href={'/our-products'}><a className={`flex items-center cursor-pointer hover:text-white ${router.pathname==='/our-products'?'text-white':'text-slate-400'}`}><span className='md:text-2xl lg:text-3xl'><GiCardboardBoxClosed /></span><span className='ml-1'>Our Products</span></a></Link>
            ...
            <form className='md:w-1/3 md:mt-3 md:mb-1 lg:my-2 lg:w-1/4'>
