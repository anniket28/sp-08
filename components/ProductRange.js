                ...
                <div className="carousel-inner py-3">
                    <div className="carousel-item active">
                        <div className='space-x-0 flex justify-center flex-col items-center space-y-3 lg:space-x-3 lg:space-y-0 lg:items-stretch lg:flex-row'>
                            <button className='bg-cyan-500 text-white rounded-md py-[6px] px-4'>New Items</button>
                            <button className='bg-orange-500 text-white rounded-md py-[6px] px-4'>Electrotherapy Equipments</button>
                            <button className='bg-red-500 text-white rounded-md py-[6px] px-4'>Rehabilitation Items</button>
                            <button className='bg-lime-600 text-white rounded-md py-[6px] px-4'>Exercise Items</button>
                            <button className='bg-indigo-500 text-white rounded-md py-[6px] px-4'>Rehabilitation Equipments</button>
                            <button className='bg-fuchsia-500 text-white rounded-md py-[6px] px-4'>Therapy Unit</button>
                        </div>
                    </div>
                    <div className="carousel-item">
                        <div className='space-x-0 flex justify-center flex-col items-center space-y-3 lg:space-x-3 lg:space-y-0 lg:items-stretch lg:flex-row'>
                            <button className='bg-slate-500 text-white rounded-md py-[6px] px-4'>Hand Wash</button>
                    ...
                    <div className="carousel-item">
                        <div className='space-x-0 flex justify-center flex-col items-center space-y-3 lg:space-x-3 lg:space-y-0 lg:items-stretch lg:flex-row'>
                            <button className='bg-green-600 text-white rounded-md py-[6px] px-4'>Hospital Furniture</button>
                            <button className='bg-orange-500 text-white rounded-md py-[6px] px-4'>Ecg Electrode Belts</button>
                            <button className='bg-pink-800 text-white rounded-md py-[6px] px-4'>Dettol Liquid Handwash</button>
                            <button className='bg-gray-500 text-white rounded-md py-[6px] px-4'>Commode Wheel Chair</button>
                            <button className='bg-indigo-500 text-white rounded-md py-[6px] px-4'>Disinfectant Liquid</button>
                            <button className='bg-fuchsia-500 text-white rounded-md py-[6px] px-4'>Wheel Chair</button>
                            </div>
                    </div>
                    <div className="carousel-item">
                        <div className='space-x-0 flex justify-center flex-col items-center space-y-3 lg:space-x-3 lg:space-y-0 lg:items-stretch lg:flex-row'>
